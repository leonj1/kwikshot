...
export const TitleBar: React.FC = () => {
  ...
  return (
    <div className="titlebar-drag h-8 bg-gray-800/90 backdrop-blur-sm border-b border-gray-700/50 flex items-center justify-between px-4">
      {/* App Title */}
      <div className="flex items-center space-x-2">
        <div className="w-4 h-4 bg-gradient-to-br from-blue-500 to-blue-600 rounded-md shadow-sm"></div>
        <span className="text-sm font-medium text-gray-300">KwikShot</span>
      </div>
